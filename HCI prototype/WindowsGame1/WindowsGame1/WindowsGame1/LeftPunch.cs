...
namespace WindowsGame1
{
    ...
    /// </summary>
    public class LeftPunch : Punch
    {
        public LeftPunch(ContentManager Content, float GameWidth, float GameHeight, float GuardY, float ScaleGuard, float ScalePunch)
        {
            ...
            tPunch = Content.Load<Texture2D>("left_punch");
