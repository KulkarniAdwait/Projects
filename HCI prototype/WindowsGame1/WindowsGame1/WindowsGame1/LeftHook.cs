...
{
    public class LeftHook : Punch
    {
        public LeftHook(ContentManager Content, float GameWidth, float GameHeight, float GuardY, float ScaleGuard, float ScalePunch)
        {
            ...
            tPunch = Content.Load<Texture2D>("left_hook");

            base.SetStartingPositions(pvGuard, pvPunch);

            punchName = "Throw a Left Hook";
        }
    }
}
