...
namespace WindowsGame1
{
    ...
    {
        public RightHook(ContentManager Content, float GameWidth, float GameHeight, float GuardY, float ScaleGuard, float ScalePunch)
        {
            ...
            tPunch = Content.Load<Texture2D>("right_hook");
